                    ...
                    <div className="pt-4 space-y-4">
                      <label className="flex items-start gap-3 cursor-pointer group">
                        ...
                        <span className="text-sm text-neutral-600 group-hover:text-neutral-900 transition-colors">
                          Acepto el tratamiento de mis datos y la <a href="/politica-privacidad" target="_blank" rel="noopener noreferrer" className="text-sanitas-blue hover:underline">política de privacidad</a> de datos. <span className="font-semibold">(Obligatorio)</span>
                        </span>
                      </label>
