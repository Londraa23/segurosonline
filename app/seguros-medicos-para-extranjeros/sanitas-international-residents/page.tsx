...
export const metadata: Metadata = {
  ...
  description: "Sanitas International Residents: cobertura completa con reembolso 80-90% para extranjeros en España. Sin copago, Dental 21 incluido, válido para residencia. Madrid. ☎ 91 726 46 33",
