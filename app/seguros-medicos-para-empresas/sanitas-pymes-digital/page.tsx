...
export const metadata: Metadata = {
  title: "Sanitas Pymes Digital — Seguro Médico para Pymes en Madrid | Sanitas Ventas",
  description: "Sanitas Pymes Digital: el seguro de salud más innovador para pymes. Cobertura completa, dental incluido, videoconsulta 24h, fisioterapia en el trabajo. Madrid. ☎ 91 726 46 33",
