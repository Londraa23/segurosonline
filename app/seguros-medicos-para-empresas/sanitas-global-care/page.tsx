...
export const metadata: Metadata = {
  ...
  description: "Sanitas Global Care: cobertura médica mundial para empleados expatriados. Reembolso 100%, hospitalización completa y sin número mínimo de asegurados.. ☎ 91 726 46 33",
